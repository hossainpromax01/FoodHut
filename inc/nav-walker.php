...
class foodhat_Walker_Nav_Menu extends Walker {
	/**
	...
	public function start_el( &$output, $data_object, $depth = 0, $args = null, $current_object_id = 0 ) {
		...
		$classes[] = 'nav-item nav-item menu-item-' . $menu_item->ID;
		 ...
		 * @param int      $depth     Depth of menu item. Used for padding.
		 */
		$class_names = implode( ' ', apply_filters( 'nav-item nav_menu_css_class', array_filter( $classes ), $menu_item, $args, $depth ) );
