<?php if(is_single()) : ?>
      <article id="<?php the_ID(); ?>" <?php post_class("foodhat-post-format-quote"); ?> >  
...
<?php else : ?>
<article id="<?php the_ID(); ?>" <?php post_class("foodhat-post-format-quote postbox__item format-quote mb-50 transition-3"); ?> >
