...
<?php else : ?>
<article id="<?php the_ID(); ?>" <?php post_class("foodhat-post-format-standard postbox__item format-image mb-50 transition-3 csearch"); ?> >
      ...
      <div class="postbox__content">
            ...
            <div class="postbox__read-more">
                  <a href=<?php the_permalink() ?>" class="tp-btn"><?php echo esc_html__('Read More','foodhat'); ?></a>                               
            </div>
      </div>
</article>
<?php endif; ?>